...
get_component_safe :: proc(ctx: ^Context, entity: Entity, $T: typeid) -> (component: ^T, error: ECS_Error) {
...
get_component :: proc(ctx: ^Context, entity: Entity, $T: typeid) -> ^T {
  component, err := get_component_safe(ctx, entity, T)
  if err != .NO_ERROR {
    panic("Failed to get component")
  }
  return component
}
